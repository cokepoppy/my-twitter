      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form class="space-y-6" @submit.prevent="handleRegister">
          ...
          <div>
            <button
              ...
              class="w-full twitter-button disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div v-if="form.password && form.confirmPassword && form.password !== form.confirmPassword" class="bg-yellow-50 border border-yellow-200 text-yellow-600 px-4 py-3 rounded-md">
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            ...
            <router-link
              to="/login"
              class="font-medium text-twitter-blue hover:text-blue-600"
            >
              Sign in
            </router-link>
          </p>
